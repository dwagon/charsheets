...
from charsheets.features import AbilityScoreImprovement, Poisoner, Archery, BoonOfTruesight
...
character.add_level(PaladinOathOfDevotion(hp=4))
character.add_level(PaladinOathOfDevotion(hp=4))
character.add_level(PaladinOathOfDevotion(hp=4, boon=BoonOfTruesight(Stat.STRENGTH)))
character.add_level(PaladinOathOfDevotion(hp=4))
