...
from charsheets.features import Expertise, ShadowTouched, AbilityScoreImprovement, BoonOfSpellRecall
...
character.add_level(BardDanceCollege(hp=5))
character.add_level(BardDanceCollege(hp=5))
character.add_level(BardDanceCollege(hp=5, boon=BoonOfSpellRecall(Stat.CHARISMA)))
character.add_level(BardDanceCollege(hp=5))
