...
character.add_level(WizardEvoker(hp=3))
...
character.add_level(WizardEvoker(hp=3, feat=AbilityScoreImprovement(Stat.INTELLIGENCE, Stat.INTELLIGENCE)))
...
character.add_level(WizardEvoker(hp=4, feat=SpellSniper(Stat.INTELLIGENCE)))
