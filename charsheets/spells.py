...
SPELL_LEVELS = {
    ...
    Spells.BANE: 1,
    Spells.BARKSKIN: 2,
    Spells.BEACON_OF_HOPE: 3,
    Spells.BEAST_SENSE: 2,
    Spells.BESTOW_CURSE: 3,
    Spells.BLADE_WARD: 0,
    Spells.BLESS: 1,
